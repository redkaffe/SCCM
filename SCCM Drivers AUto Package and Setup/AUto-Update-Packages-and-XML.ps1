...
{	
	...
	Function SetGlobalEnvVariables
	{
        ...
        $Script:LoggingPath = "\\EFP-CCMCASP-01.ECM.ERA\D$\DriversToolAutomate\Logs\Update-XML-File.log"
        ...
        $Script:SiteServer = "EFP-CCMCASP-01.ECM.ERA"
        ...
        $Script:ScriptPath = "\\EFP-CCMCASP-01.ECM.ERA\D$\DriversToolAutomate\Update-XML-File.ps1"
