...
{	
	...
	Function SetGlobalEnvVariables
	{
        ...
        $Script:LoggingPath = "d:\DriversToolAutomate\Logs\Update-XML-File.log"
        ...
        $Script:SiteServer = "EFP-CCMCASP-01V.ECM.ERA"
        ...
        $Script:ScriptPath = "d:\DriversToolAutomate\Update-XML-File.ps1"
 	...
 	Function LogTraceMessage ($strMessage)
	{
 	...
 	# Script Started
	LogTraceMessage "*** Get-DriverPackage ***"
    Write-Verbose "*** Get-DriverPackage ***"
...
Finally
{
	...
	# Script Finished
	LogTraceMessage "*** Get-DriverPackage Finished ***"
    Write-Verbose "*** Get-DriverPackagefinished Finished ***"
